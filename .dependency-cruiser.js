  ...
  forbidden: [
    ...
    },
    {
      ...
      from: {
        path: "^(src)",
        pathNot:
          "(?:[.](?:spec|test)[.](?:js|mjs|cjs|jsx|ts|mts|cts|tsx)|vite-env[.]d[.]ts)$"
      },
      to: {
    ...
    // custom rules
    {
      name: "player-to-match",
      comment: "",
      severity: "error",
      from: {
        path: "(/components/player)",
        pathNot: "(/components/player/debug)"
      },
      to: { path: "(/components/match)" }
    },
    {
      name: "to-debug",
      comment: "",
      ...
      from: {
        path: "^(src)",
        pathNot: "(^src/World/world.factory.ts|/debug/|player.logger.ts$)"
      },
      to: { path: "(/debug/)" }
    }
  ],
...
// generated: dependency-cruiser@16.8.0 on 2024-12-21T16:31:52.004Z
